...
int main(int argc, char** argv) {
    ...
    while(!startup_srv.response.success){
    	ROS_WARN("Not successfully started yet");
    ...
    int nparts_missing = part_indices_missing.size();    
        
	for(int i=0;i<nparts_missing;i++){
    ...
    nparts_missing = part_indices_missing.size();    
